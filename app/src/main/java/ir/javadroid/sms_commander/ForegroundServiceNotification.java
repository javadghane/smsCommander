...
public class ForegroundServiceNotification extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        builder.setTicker("Application is Running");
        builder.setContentText("Click to open");
        builder.setContentText("touch here");
       // builder.setTicker("كؤنترولى زيره ك و سه ر ده ميانه");
      //  builder.setContentText("ليره بده تا بكريته وه");
